...
### Repositorio Flatpak de COSMIC

> Flathub no acepta applets de escritorio, así que se distribuye por el
> [repositorio Flatpak de COSMIC](https://github.com/pop-os/cosmic-flatpak)
> (enviado, pendiente de revisión). Una vez aceptado, instálalo con:
...
│   └── cosmic-flatpak/                             # Manifiesto para el repo de COSMIC
...
- [`docs/DEPLOYMENT.md`](docs/DEPLOYMENT.md) — guía paso a paso para publicar.
- [`docs/LECCIONES-APRENDIDAS.md`](docs/LECCIONES-APRENDIDAS.md) — historia del proceso, errores reales y buenas prácticas.

## 🗺️ Roadmap

- [ ] **Publicación en el repositorio Flatpak de COSMIC** (App ID `io.github.diegoachury.CaffeineCosmic`).
